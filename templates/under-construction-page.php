...
<body class="portfolio-body">
  ...
  <main class="container">
    <div class="row">
      <p class="col-12 offset-md-2 col-md-8 mb-5 d-flex justify-content-center text-center construction-text">The projects on this page are in various stages of construction. I am using Netlify so that updates (and mistakes!) can be seen in real time with each git push.</p>
      ...
      <a href="https://github.com/FreudCat/ceramic-arts" target="_blank"><i class="fab fa-github construction-icon github-icon"></i></a>
      </div>
    </div>
  </main>
