        ...
        <div class="accordion-item">
          ...
          <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#abstract-accordion">
            <div class="accordion-body">
              <p>This page uses the Bootstrap framework and SASS to provide layout and styling. Items can be added or removed from the cart, and the items will persist via Local Storage until the user clears the cache. The modal image is dynamically created based on the main image.</p>
            </div>
          </div>
        </div>
      </div>
