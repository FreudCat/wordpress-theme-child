      ...
      <nav class="navbar navbar-expand-md navbar-light pt-1 pb-3 pt-md-3 pb-md-0 mb-xxl-5 mx-md-5 px-xl-5 justify-content-md-start shopping-nav">
        <div class="d-inline-flex me-lg-auto">
          ...
          <div class="collapse navbar-collapse mt-4 mt-lg-2 mt-xxl-0 pt-lg-1">
              <a class = "nav-link header-link px-0 pb-4 pb-lg-0 me-3 me-lg-4 mt-xxl-5" href="http://pract1.local/">Home</a>
              <a class = "nav-link header-link px-0 pb-4 pb-lg-0 me-3 me-lg-4 mt-xxl-5" href="#">Men</a>
              <a class = "nav-link header-link px-0 pb-4 pb-lg-0 me-3 me-lg-4 mt-xxl-5" href="#">Women</a>
              <a class = "nav-link header-link px-0 pb-4 pb-lg-0 me-3 me-lg-4 mt-xxl-5" href="#">About</a>
              <a class = "nav-link header-link px-0 pb-4 pb-lg-0 me-5 mt-xxl-5" href="#">Contact</a>
          </div>
        </div>
